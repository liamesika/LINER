...
export const examsData: ExamData[] = [
  {
    ...
    topicDistribution: {
      'fields': 0, 'vector-spaces': 0, 'subspaces': 1, 'linear-combinations': 0,
      'span': 0, 'linear-independence': 0, 'basis': 0, 'dimension': 0,
      'linear-transformations': 1, 'matrix-representation': 0, 'change-of-basis': 0,
      'rank': 0, 'nullity': 0, 'systems-of-equations': 0, 'row-reduction': 0,
      'determinants': 0, 'eigenvalues': 1, 'eigenvectors': 0, 'diagonalization': 0,
      'inner-products': 0, 'orthogonality': 0, 'gram-schmidt': 1, 'least-squares': 0,
      'singular-values': 0, 'jordan-form': 0, 'bilinear-forms': 0, 'quadratic-forms': 0, 'other': 0
    },
  ...
  },
  {
    ...
    topicDistribution: {
      'fields': 0, 'vector-spaces': 0, 'subspaces': 0, 'linear-combinations': 0,
      'span': 0, 'linear-independence': 0, 'basis': 0, 'dimension': 0,
      'linear-transformations': 0, 'matrix-representation': 1, 'change-of-basis': 0,
      'rank': 1, 'nullity': 0, 'systems-of-equations': 0, 'row-reduction': 0,
      'determinants': 0, 'eigenvalues': 0, 'eigenvectors': 0, 'diagonalization': 0,
      'inner-products': 0, 'orthogonality': 0, 'gram-schmidt': 0, 'least-squares': 0,
      'singular-values': 0, 'jordan-form': 0, 'bilinear-forms': 0, 'quadratic-forms': 0, 'other': 0
    },
  ...
  },
  {
    ...
    topicDistribution: {
      ...
      'linear-transformations': 1, 'matrix-representation': 0, 'change-of-basis': 0,
      'rank': 0, 'nullity': 0, 'systems-of-equations': 0, 'row-reduction': 0,
      'determinants': 1, 'eigenvalues': 0, 'eigenvectors': 0, 'diagonalization': 1,
      'inner-products': 0, 'orthogonality': 0, 'gram-schmidt': 0, 'least-squares': 0,
      'singular-values': 0, 'jordan-form': 0, 'bilinear-forms': 0, 'quadratic-forms': 0, 'other': 0
    },
  ...
  },
  {
    ...
    topicDistribution: {
      'fields': 0, 'vector-spaces': 0, 'subspaces': 0, 'linear-combinations': 0,
      'span': 0, 'linear-independence': 0, 'basis': 1, 'dimension': 0,
      'linear-transformations': 0, 'matrix-representation': 1, 'change-of-basis': 0,
      'rank': 0, 'nullity': 0, 'systems-of-equations': 0, 'row-reduction': 0,
      'determinants': 0, 'eigenvalues': 0, 'eigenvectors': 0, 'diagonalization': 0,
      'inner-products': 0, 'orthogonality': 0, 'gram-schmidt': 0, 'least-squares': 0,
  ...
  },
  {
    ...
    topicDistribution: {
      'fields': 0, 'vector-spaces': 0, 'subspaces': 0, 'linear-combinations': 0,
      'span': 0, 'linear-independence': 0, 'basis': 0, 'dimension': 1,
      'linear-transformations': 0, 'matrix-representation': 0, 'change-of-basis': 1,
      'rank': 0, 'nullity': 0, 'systems-of-equations': 0, 'row-reduction': 0,
      'determinants': 1, 'eigenvalues': 0, 'eigenvectors': 0, 'diagonalization': 0,
      'inner-products': 0, 'orthogonality': 0, 'gram-schmidt': 0, 'least-squares': 1,
      'singular-values': 0, 'jordan-form': 0, 'bilinear-forms': 0, 'quadratic-forms': 0, 'other': 0
    },
