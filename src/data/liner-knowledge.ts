...
export const topicSummary = {
  ...
  'linear-transformations': { name: 'Linear Transformations', count: getItemsByTopic('linear-transformations').length },
  'matrix-representation': { name: 'Matrix Representation', count: getItemsByTopic('matrix-representation').length },
  'change-of-basis': { name: 'Change of Basis', count: getItemsByTopic('change-of-basis').length },
  'rank': { name: 'Rank', count: getItemsByTopic('rank').length },
  'nullity': { name: 'Nullity', count: getItemsByTopic('nullity').length },
  ...
  'eigenvalues': { name: 'Eigenvalues', count: getItemsByTopic('eigenvalues').length },
  'eigenvectors': { name: 'Eigenvectors', count: getItemsByTopic('eigenvectors').length },
  'diagonalization': { name: 'Diagonalization', count: getItemsByTopic('diagonalization').length },
  'inner-products': { name: 'Inner Products', count: getItemsByTopic('inner-products').length },
  'orthogonality': { name: 'Orthogonality', count: getItemsByTopic('orthogonality').length },
  'gram-schmidt': { name: 'Gram-Schmidt', count: getItemsByTopic('gram-schmidt').length },
  'least-squares': { name: 'Least Squares', count: getItemsByTopic('least-squares').length },
}
